...
function maskLayer(){
	...
	jQuery('#maskLayer_iframe').css({position:"absolute",left:"0px",top:"0px"}).height(FH).width(FW);
}

function draglayer(){
	var och=jQuery("#drag").height();
	var ocw=jQuery("#drag").width();
