...
<span class="views-field views-field-place"><span class="field-content"><?php print t('地点:') ?><?php print $fields['field_event_place']->content ?></span>  </span>

<span class="views-field views-field-time"><span class="field-content"><?php print t('日期:') ?><?php print $fields['field_event_date']->content ?></span>  </span>
