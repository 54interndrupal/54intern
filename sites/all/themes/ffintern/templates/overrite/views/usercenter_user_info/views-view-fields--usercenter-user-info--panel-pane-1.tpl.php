...
<div class="user-info">
  ...
  <div class="views-field">
    <a href="<?php print base_path() . 'user?qt-user_center_tab=3#qt-user_center_tab' ?>"><span style="font-size: 12px;color: #336600">申请的职位 ></span></a>
  </div>
  <div class="views-field">
  ...
  <div class="views-field">
    <a href="<?php print base_path() . 'user?qt-user_center_tab=4#qt-user_center_tab' ?>"><span style="font-size: 12px;color: #336600">收藏的文章 ></span></a>
  </div>
