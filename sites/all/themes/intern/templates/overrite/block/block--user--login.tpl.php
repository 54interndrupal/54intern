...
<div id="temp-login" class="block">
	...
	<h2 class="block-title"><span id="normal-user-login-title" class="active"><a href="#"><?php print t('个人用户登录') ?></a></span> <span id="company-user-login-title"><a href="#"><?php print t('企业用户登录') ?></a></span></h2>
	
	<div class="block-content" id="normal-user-login-content">
    <?php print $content ?>
  </div>
...
alert('1234345');
  ...
  $("#temp-login #company-user-login-title").onClick(function(event) {
  ...
  $("#temp-login #normal-user-login-title").onclick(function(event) {
...
<script type="text/javascript">
  ...
  $("#temp-login #normal-user-login-title").removeClass('active');
  $("#temp-login #company-user-login-title").addClass('active');
   $("#temp-login #normal-user-login-content").css('display','none');
   $("#temp-login #company-user-login-content").css('display','block');
    return false;		
  }); 
 ...
 $("#temp-login #company-user-login-title").removeClass('active');
 $("#temp-login #normal-user-login-title").addClass('active');
   $("#temp-login #company-user-login-content").css('display','none');
   $("#temp-login #normal-user-login-content").css('display','block');
    return false;		
  }); 
