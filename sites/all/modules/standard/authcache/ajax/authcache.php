...
// Register a shutdown function (that will prevent other shutdown functions from running)
drupal_register_shutdown_function('_authcache_shutdown');
...
/**
 * Shutdown function prevents other shutdown functions (eg xhprof) from corrupting the javascript output
 */
function _authcache_shutdown() {
  exit;
}
